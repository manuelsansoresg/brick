                            ...
                            <div class="row ">
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-group mb-2">
                                        ...
                                        <div class="w-100"></div>
                                        <input type="text" name="Descripcion" class="form-control" value="{{ $color->Descripcion }}">
                                        <div class="w-100"></div>
                                        @if($errors)
                            ...
                            <div class="row">
                                <div class="col-12 col-md-4">
                                    <div class="form-group mb-2">
                                        ...
                                        <div class="w-100"></div>
                                        <input type="text" name="Abreviatura" class="form-control" value="{{ $color->Abreviatura }}">
                                        <div class="w-100"></div>
                                        @if($errors)
