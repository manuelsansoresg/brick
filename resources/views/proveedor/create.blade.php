                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-9">
                                    ...
                                    <input name="Nombre" class="form-control form-control-sm" type="text" placeholder="NOMBRE">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-2">
                                    ...
                                    <input name="NumeroExterior" class="form-control form-control-sm" type="text" placeholder="NO.EXTERIOR">
                                </div>
                                <div class="col-12 col-md-2">
                                    <label class="small">NO.INT</label>
                                    <input class="form-control form-control-sm" type="text" placeholder="NO.INTERIOR" name="NumeroInterior">
                                </div>
                                <div class="col-12 col-md-5">
                                    <label class="small">COLONIA</label>
                                    <input class="form-control form-control-sm" type="text" placeholder="COLONIA" name="Colonia">
                                </div>
                                <div class="col-12 col-md-3">
