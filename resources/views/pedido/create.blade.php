                            ...
                            <div class="row ">
                                <div class="col-12 col-md-4">
                                   ...
                                   <div class="input-group">
                                        ...
                                        <input type="text" name="FechaEntrega" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy-mm-dd" data-mask="" im-insert="false">
                                    </div>
                                    <div class="w-100"></div>
                                    @if($errors)
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <div class="w-100"></div>
                                        <textarea name="Observaciones" cols="30" rows="10" class="form-control"></textarea>
                                        <div class="w-100"></div>
                                        @if($errors)
