            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"> <a href="/admin/departamento">DEPARTAMENTO</a> </li>
                            ...
                            <div class="row ">
                                <div class="col-12 col-md-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <div class="w-100"></div>
                                        <input type="text" name="Descripcion" class="form-control form-control-sm" value="{{ $departamento->Descripcion }}">
                                        <div class="w-100"></div>
                                        @if($errors)
